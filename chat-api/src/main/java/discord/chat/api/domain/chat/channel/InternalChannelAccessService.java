...
public class InternalChannelAccessService {
    ...
    public List<AccessibleTextChannelResponse> getAccessibleTextChannels(String userId)
        ...
        return chatSubscriptMongoRepository.findAllByUser(user).stream()
            .flatMap(subscription -> textChannelMongoRepository
                .findAllByChatRoom(subscription.getChatRoom())
                .stream())
